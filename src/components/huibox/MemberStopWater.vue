    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item label="类型">
        <el-select v-model="formInline.regions">
          <el-option label="停卡" value="xiaoshou"></el-option>
          <el-option label="转店" value="shi"></el-option>
          <el-option label="补卡" value="buka"></el-option>
        </el-select>
      </el-form-item>
  ...
  data () {
    ...
    return {
      ...
      tableTitle: [
        ...
        { title: '合同号', data: 'userNo' },
        { title: '会籍类型', data: 'userCardNo' },
        { title: '开始日期', data: 'sex' },
        { title: '结束日期', data: 'cardClass' },
        { title: '停卡开始', data: 'cardNo' },
        { title: '停卡结束', data: 'photo' },
        { title: '开卡日期', data: 'cardPhoto' },
        { title: '新合同号', data: 'caryi' },
        { title: '手续费', data: 'carcu' }
