...
<template>
  <div class='app'>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="subjectCode" label="类别" width="150"></el-table-column>
      <el-table-column prop="remark" label="初审" width="80"></el-table-column>
      <el-table-column prop="status" label="复审" width="80"></el-table-column>
      <el-table-column prop="remark" label="终审" width="80"></el-table-column>
