...
<template>
  <div class='pact'>
    <el-form ref="form" :model="form" label-width="80px" class="formbox">
      ...
      <div class="shenfen">
        <el-form-item label="原停卡费">
          <el-input v-model="input" disabled></el-input>
        </el-form-item>
        <el-form-item label-width='82px' label="原转让费">
          <el-input v-model="input" disabled></el-input>
        </el-form-item>
      </div>

      <div class="shenfen">
        <el-form-item label="原补卡费">
          <el-input v-model="input" disabled></el-input>
        </el-form-item>
        <el-form-item label-width='82px' label="原转店费">
          <el-input v-model="input" disabled></el-input>
        </el-form-item>
      </div>
      <hr>
      <div class="shenfen">
        <el-form-item label="新补卡费">
          <el-input v-model="input"></el-input>
        </el-form-item>
        <el-form-item label-width='82px' label="新转店费">
          <el-input v-model="input"></el-input>
        </el-form-item>
      </div>

      <div class="shenfen">
        <el-form-item label="新转店费">
          <el-input v-model="input"></el-input>
        </el-form-item>
        <el-form-item label-width='82px' label="新转店费">
          <el-input v-model="input"></el-input>
