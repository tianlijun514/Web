    ...
    <el-form ref="form" :model="form" label-width="80px" class="formbox">
      ...
      <div class="conment">
        ...
        <div class="shenfen">
          ...
          <el-form-item label="定金类型" label-width='82px'>
            <el-input v-model="input" disabled></el-input>
          </el-form-item>
        </div>
      ...
      <div class="shenfen">
        ...
        <el-form-item>
          <el-button type="primary" @click="onSubmit">否决</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="prufen()">审批历史</el-button>
        </el-form-item>
      </div>
    </el-form>
    <Zahlung :antrage="antrage"></Zahlung>
  </div>
</template>
