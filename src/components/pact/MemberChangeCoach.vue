    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      <el-form-item label="门店">
       ...
       <span class="demonstration">日期范围</span>
        <el-date-picker v-model="value1" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" size='mini'>
        </el-date-picker>
  ...
  data () {
    ...
    return {
      ...
      tableTitle: [
        ...
        { title: '会员名称', data: 'userNo' },
        { title: '课程', data: 'userCardNo' },
        { title: '教练', data: 'sex' },
        { title: '新教练', data: 'cardClass' },
      ],
      tableData: [{
        num: '00012',
        storeName: '天府四街分店',
