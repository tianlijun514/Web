    ...
    <div class="pact">
        <el-form ref="form" :model="form" label-width="80px" class="formbox">
            ...
            <div class="shenfen">
                ...
                <el-form-item label="指导价范围" label-width="82px" class="lefty">
            ...
            <div class="shenfen">
                <el-form-item label="合同起日">
                    <el-input suffix-icon="el-icon-date" v-model="form.date1" style="width: 185px;"></el-input>
                </el-form-item>

                <el-form-item label="合同迄日" style="margin-left: 28px;">
                    <el-input suffix-icon="el-icon-date" v-model="form.date2" style="width: 185px;"></el-input>
                </el-form-item>
            </div>
            <div class="shenfen">
