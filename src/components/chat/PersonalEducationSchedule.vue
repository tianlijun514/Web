...
<template>
  <div class='app'>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="Hebian" label="合同编号"></el-table-column>
      ...
      <el-table-column prop="yutime" label="预约时间"></el-table-column>
      <el-table-column prop="hetime" label="上课时间"></el-table-column>
      <el-table-column prop="yuyue" label="状态"></el-table-column>
    </el-table>
    <div class="block">
