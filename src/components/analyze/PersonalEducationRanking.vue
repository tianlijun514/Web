...
<template>
  <div class='app'>
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="typeCode" label="序号"></el-table-column>
      ...
      <el-table-column prop="typeName" label="POS私教数"></el-table-column>
      <el-table-column prop="subjectCode" label="POS私教金额"></el-table-column>
      <el-table-column prop="typeCode" label="新单私教数"></el-table-column>
      <el-table-column prop="typeName" label="新单私教金额"></el-table-column>
      <el-table-column prop="subjectCode" label="续单私教数"></el-table-column>
      <el-table-column prop="subjectCode" label="续单私教金额"></el-table-column>
      <el-table-column prop="typeName" label="调整私教数"></el-table-column>
      <el-table-column prop="subjectCode" label="调整私教金额"></el-table-column>
