...
<template>
  <div class='app'>
    ...
    <el-table :data="tableData" border style="width: 100%">
      <el-table-column prop="cgRk.deptCode" label="部门编号" width="80"></el-table-column>
      <el-table-column prop="cgRk.deptName" label="部门名称" width="110"></el-table-column>
      <el-table-column prop="oaCode" label="OA订单号" width="100"></el-table-column>
      ...
      <el-table-column prop="cgRk.cgDate" label="采购日期" width="120"></el-table-column>
      <el-table-column prop="cgRk.empName" label="操作员" width="120"></el-table-column>
    </el-table>
    <div class="block">
...
export default {
  ...
  methods: {
    ...
    Statistische () {
      axios
        .post(base + '/commodity/getAllCgRk', {
