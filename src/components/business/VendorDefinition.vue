    ...
    <el-form :inline="true" class="demo-form-inline">
      ...
      <el-dialog :title="title" :visible.sync="dialogVisible" width="30%">
        <el-form :model="numberValidateForm" ref="numberValidateForm" class="demo-ruleForm" :rules="rules">
          ...
          <el-form-item label="备注" prop="remark" style="margin-left: 10px;">
            <el-input v-model.number="numberValidateForm.remark" autocomplete="off" type="textarea" style="width: 185px"></el-input>
          </el-form-item>
          <br>
...
export default {
  ...
  methods: {
    ...
    chaxun () {
      axios.
        post(base + '/commodity/getSupplier', {
