        ...
        <el-table :data="table" border style="width: 100%;text-align:center">
            ...
            <el-table-column label="操作" width="300">
                <template slot-scope="scope" >
                    ...
                    <el-button size="mini" type="primary" @click="jump">设置权限</el-button>
...
export default {
    ...
    methods: {
        ...
        add() {
            if (this.dialogShow != 'addUserPermissions') {
                this.dialogShow = 'addUserPermissions';
            } else {
                this.dialogShow = 'addUserPermissions1';
            }
        },
        jump(){
          this.$router.push('/operation15')
        }
    },
