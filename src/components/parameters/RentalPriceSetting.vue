...
<template>
    <div class="APPX">
        <el-form :inline="true" :model="form" class="demo-form-inline">
            <el-form-item>
                <el-button type="primary" @click="add">门店等级设置</el-button>
            </el-form-item>
        </el-form>
        ...
        <el-table :data="table" border style="width: 100%;text-align:center">
            ...
            <el-table-column prop="name" label="年租金"></el-table-column>
            <el-table-column prop="name" label="月租金"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        add() {
            if(this.dialogShow!='storeLevel'){
              this.dialogShow='storeLevel'
            }else{
              this.dialogShow='storeLevel1'
            }
        },
        update(e){
          console.log(e)
          if(this.dialogShow!='updatePrice'){
              this.dialogShow='updatePrice'
            }else{
              this.dialogShow='updatePrice1'
            }
        }
    },
