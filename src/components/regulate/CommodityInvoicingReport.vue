...
export default {
  ...
  data () {
    ...
    return {
      ...
      tableTitle: [
        { title: '商品编号', data: 'num' },
        { title: '商品名称', data: 'storeName' },
        { title: '单位', data: 'name' },
        { title: '入库数量(+)', data: 'phone' },
        { title: '退货数量(-)', data: 'idCard' },
        { title: '配送入库数量(+)', data: 'timeHorizon' },
        { title: '配送入库数量(-)', data: 'type' },
        { title: '销售数量(-)', data: 'dan' },
        { title: '报损数量(+-)', data: 'eag' },
        { title: '领用数量(-)', data: 'danjia' },
        { title: '当前库存数量', data: 'money' },
      ],
      tableData: [{}],
